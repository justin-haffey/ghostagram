...
| Connector profiles | Implemented | Straight, orthogonal flowchart with serializable stub and rounded-corner geometry, tangent-preserving Bezier, arched Curved, and state-machine path profiles. |
