# Ghostplumb practical browser-UI parity matrix

This is a clean-room comparison against `vendor/jsplumb-community/dist/browser-ui/js/jsplumb.browser-ui.es.js`. It is a capability target, not a promise of source or API compatibility. Ghostplumb deliberately has a smaller, versioned API for future C#/Razor interop.

| Browser diagramming family | Ghostplumb status | Notes |
| --- | --- | --- |
