...
```javascript
import * as ghostplumb from "./ghostplumb.js";

const hello = ghostplumb.create(hostElement, {
  protocolVersion: 1,
  eventSink: dotNetReference,
  eventMethod: "OnGhostplumbEvent"
});

ghostplumb.replace(hello.instanceId, {
  requestId: "load-1",
