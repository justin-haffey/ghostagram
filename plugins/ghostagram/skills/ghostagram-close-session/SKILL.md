...
4. Accept `CLOSED` or `ALREADY_CLOSED`. Do not retry an uncertain close blindly; reconcile session state first.
5. Verify the response names the same session and reports a terminal close result.
